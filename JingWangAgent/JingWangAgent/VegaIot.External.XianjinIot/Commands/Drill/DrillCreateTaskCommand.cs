...
internal class DrillCreateTaskCommand : SimpleCommand<DefaultDrill>
{
    ...
    {
        var createTaskAckPayload = new DrillCreateTaskAckPayload()
        {
        ...
        await _mqttClient.PublishBinaryAsync("jlc/mes/drilling/report/create_task_ack", JsonSerializer.Serialize(createTaskAckPayload).GetBytes(), MQTTnet.Protocol.MqttQualityOfServiceLevel.ExactlyOnce);
    }
}
