...
{
    public class BackPanelAgvEventHandler : DeviceShare<DefaultAgv>, IAgvEventHandler
    {
        private readonly ILogger<BackPanelAgvEventHandler> logger;

        public BackPanelAgvEventHandler(ILogger<BackPanelAgvEventHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
