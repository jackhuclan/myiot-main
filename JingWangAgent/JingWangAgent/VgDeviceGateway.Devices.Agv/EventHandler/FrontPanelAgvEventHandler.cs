...
{
    public class FrontPanelAgvEventHandler : DeviceShare<DefaultAgv>, IAgvEventHandler
    {
        private readonly ILogger<FrontPanelAgvEventHandler> logger;

        public FrontPanelAgvEventHandler(ILogger<FrontPanelAgvEventHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
