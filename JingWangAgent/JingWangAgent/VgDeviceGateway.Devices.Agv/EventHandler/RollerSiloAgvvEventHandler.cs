...
{
    public class RollerSiloAgvvEventHandler : DeviceShare<DefaultAgv>, IAgvEventHandler
    {
        private readonly ILogger<RollerSiloAgvvEventHandler> logger;

        public RollerSiloAgvvEventHandler(ILogger<RollerSiloAgvvEventHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
