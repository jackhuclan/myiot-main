...
{
    public class ShelfSiloAgvEventHandler : DeviceShare<DefaultAgv>, IAgvEventHandler
    {
        private readonly ILogger<ShelfSiloAgvEventHandler> logger;

        public ShelfSiloAgvEventHandler(ILogger<ShelfSiloAgvEventHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
