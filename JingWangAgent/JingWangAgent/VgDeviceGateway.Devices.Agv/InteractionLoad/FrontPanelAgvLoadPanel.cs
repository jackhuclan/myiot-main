...
{
    public class FrontPanelAgvLoadPanel : DeviceShare<DefaultAgv>, IAgvLoadInteraction
    {
        private readonly ILogger<FrontPanelAgvLoadPanel> logger;

        public FrontPanelAgvLoadPanel(ILogger<FrontPanelAgvLoadPanel> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
