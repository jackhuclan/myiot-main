...
{
    public class RollerSiloAgvPropertyHandler : DeviceShare<DefaultAgv>, IAgvPropertyHandler
    {
        private readonly ILogger<RollerSiloAgvPropertyHandler> logger;

        public RollerSiloAgvPropertyHandler(ILogger<RollerSiloAgvPropertyHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
