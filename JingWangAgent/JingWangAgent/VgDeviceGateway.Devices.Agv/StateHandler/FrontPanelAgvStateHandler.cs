...
{
    public class FrontPanelAgvStateHandler : DeviceShare<DefaultAgv>, IAgvStateHandler
    {
        private readonly ILogger<FrontPanelAgvStateHandler> logger;

        public FrontPanelAgvStateHandler(ILogger<FrontPanelAgvStateHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
