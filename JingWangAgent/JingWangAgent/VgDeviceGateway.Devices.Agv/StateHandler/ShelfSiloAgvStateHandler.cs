...
{
    public class ShelfSiloAgvStateHandler : DeviceShare<DefaultAgv>, IAgvStateHandler
    {
        private readonly ILogger<ShelfSiloAgvStateHandler> logger;

        public ShelfSiloAgvStateHandler(ILogger<ShelfSiloAgvStateHandler> logger, IServiceProvider serviceProvider, DefaultAgv device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
