...
namespace VgDeviceGateway.Devices.Drill.Other.CodeReader
{
    public class TcpIpClient : IDisposable
    {
        ...
        public TcpIpClient Connect(string hostNameOrIpAddress, int port)
        {
            ...
            try
            {
                var result = _client.BeginConnect(hostNameOrIpAddress, port, null, null);
