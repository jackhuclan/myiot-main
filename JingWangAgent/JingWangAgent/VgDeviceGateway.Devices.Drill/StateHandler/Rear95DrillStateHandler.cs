...
{
    public class Rear95DrillStateHandler : DeviceShare<DefaultDrill>, IDrillStateHandler
    {
        private readonly ILogger<Rear95DrillStateHandler> logger;

        public Rear95DrillStateHandler(ILogger<Rear95DrillStateHandler> logger, IServiceProvider serviceProvider, DefaultDrill device) : base(serviceProvider, device)
        {
            this.logger = logger;
        }
