...
public class RearPanelIotDrillStateHandler : DeviceShare<DefaultDrill>, IDrillStateHandler
{
    private readonly ILogger<RearPanelIotDrillStateHandler> logger;

    public RearPanelIotDrillStateHandler(ILogger<RearPanelIotDrillStateHandler> logger, IServiceProvider serviceProvider, DefaultDrill device) : base(serviceProvider, device)
    {
        this.logger = logger;
    }
