...
using VgDeviceGateway.Devices.Pin.Plc;
...
public class Pin : Device
{
    ...
    protected override async Task OnApplicationStarted()
    {
        ...
        //{
        //    PayloadPanels.AddRange(Panel.SiloNoPanelSpindleFirst(spindleNum * layerLimit, layerLimit));
        //}
    ...
    public async Task<ushort[]> ReadPlc(CurrentContext currentContext)
    {
        switch (currentContext.PlcHandleType)
        {
            ...
            case 1:
                ...
                var Layer = modbusIpMaster.ReadHoldingRegisters(1, 23, 1)[0];
    ...
    public async Task<bool> WritePlc(CurrentContext currentContext)
    {
        switch (currentContext.PlcHandleType)
        {
            ...
            //    break;
            case 5:
                var value = currentContext.PlcValue.ToFloat().StringFloatToUshort();
