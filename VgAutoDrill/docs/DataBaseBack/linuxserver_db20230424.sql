...
CREATE TABLE `t_board_trace` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='板料追踪';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_device_panel` VALUES (2,0,'string','string','string','string','string','string',0,0,0,NULL,1,0,1,'2023-04-20 21:14:43',NULL,NULL);
INSERT INTO `t_device_panel` VALUES (3,0,'string','string','string','string','string','string',0,0,0,NULL,1,0,1,'2023-04-20 21:14:46',NULL,NULL);
...
CREATE TABLE `t_work_order` (
  ...
  `ancestors` varchar(255) DEFAULT NULL COMMENT '所有层级父节点',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产工单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_work_order` VALUES (39,'20230423客户订单',0,'MO202304230001','客户订单',NULL,36,'PCB单层板','IF2023040500002',22,NULL,'DDD XXXX DD','Panel',NULL,NULL,NULL,NULL,41,'张老板','001','2023-04-23 00:00:00','COMMITED',0,1,33,'2023-04-23 02:53:50','2023-04-23 02:54:17',33,'0');
...
-- Dump completed on 2023-04-24  8:10:11
