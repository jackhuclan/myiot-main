...
INSERT INTO `sys_position` VALUES (2,'项目经理',NULL,6,0,1,NULL,'2022-11-08 13:56:56','2023-05-05 03:12:20',1);
...
INSERT INTO `sys_user` VALUES (38,'zyy123','71cce1c95a3f8a9168228b860e4e95e8','339ecbed55004c0bad580be24311f90b','zyy',10,4,0,NULL,NULL,'18810988976','13400000001@qq.com',NULL,NULL,NULL,'',NULL,0,1,1,'2023-05-05 05:09:46',NULL,NULL);
...
INSERT INTO `sys_user_role` VALUES (18,38,8,1,'2023-05-05 05:09:47');
...
CREATE TABLE `t_alarm_setting` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='告警配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_check_records` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COMMENT='检验记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_check_records` VALUES (29,64,'#0001','叠板',25,'MO202304030001','PCB单层',1,'admin','1','2023-05-05 04:38:50','5/5检验合格',1,0,1,'2023-05-05 04:23:02',NULL,NULL);
...
CREATE TABLE `t_client` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COMMENT='客户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_cutter_config_detail` VALUES (57,16,3.110,1.000,1.000,1.000,1.000,1,0,1,1,'2023-05-04 22:48:36',NULL,NULL);
...
INSERT INTO `t_feedback` VALUES (31,'自行报工',212,'drill01-0001','钻机01-0001',21,'MO202304050003','PCB单层',22,'drill','钻孔',40,'钻孔1',36,'IF2023040500002','PCB单层板',22,'Panel','DDD XXXX DD',NULL,130.00,119.00,21.00,'xiaoming','yp1',NULL,'2023-04-26 00:00:00',NULL,'DRAFT',NULL,0,1,1,'2023-04-21 01:05:40','2023-05-05 02:02:35',1);
...
CREATE TABLE `t_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='物料产品定义表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item_atp_file` VALUES (2,'IF2023040500002','PCB单层板',36,22,'生成0.2173534380870079','ATP0.41596983821172495','string',0,NULL,'\\\\fileServer\\IF200001111\\IF200001111.drl',0,NULL,'\\\\fileServer\\IF200001111\\IF200001111.dia',2,2,2,1,'2023-04-07 07:35:18',0,1,1,'2023-04-07 15:35:28','2023-05-05 00:49:42',1);
INSERT INTO `t_item_atp_file` VALUES (15,'IF','PCB单层板',36,22,'生成0.9915404195545661','ATP0.38611528793041194',NULL,NULL,NULL,'\\\\\\\\fileServer\\\\IF200001111\\\\IF200001111.drl',NULL,NULL,'\\\\\\\\fileServer\\\\IF200001111\\\\IF200001111.dia',1,5,10,0,'2023-04-12 01:04:00',0,1,33,'2023-04-11 21:07:20','2023-05-05 00:48:36',1);
...
INSERT INTO `t_item_atp_file` VALUES (44,'IF2023040500002','PCB单层板',36,22,NULL,NULL,NULL,NULL,'维嘉1','/root/admin1.0/data/dia/维嘉.txt',NULL,'维嘉2','/root/admin1.0/data/dia/维嘉.txt',2,2,3,0,NULL,0,1,1,'2023-05-04 23:11:14','2023-05-04 23:27:36',1);
...
CREATE TABLE `t_item_atp_file_detail` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9761 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='ATP文件明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item_drill_file` VALUES (16,'IF2023040500002','PCB单层板',36,22,'PCB单层板','\\\\fileServer\\IF200001111\\IF200001111.drl',0,1,1,'2023-04-19 01:03:56','2023-05-04 22:56:46',1);
...
INSERT INTO `t_item_drill_file` VALUES (21,'IF2023040500002','PCB单层板',36,22,'钻带文件001','\\\\fileServer\\IF200001111\\IF200001111.drl',0,1,1,'2023-05-05 02:27:27',NULL,NULL);
...
INSERT INTO `t_item_type` VALUES (41,'11',22,'111',2,NULL,'0,1,22',0,1,1,'2023-05-05 04:06:02','2023-05-05 04:06:38',1);
...
CREATE TABLE `t_material_stock` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='库存记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_material_stock` VALUES (11,'123','1',1,1,'in',22,36,'IF2023040500002','Panel单层02','11','Panel',1.00,NULL,'22',2,'WareHouse2','WareHouse2',NULL,25,'MO202304030001',NULL,NULL,NULL,NULL,0,1,1,'2023-04-21 01:57:25','2023-05-04 04:30:50',1);
...
INSERT INTO `t_material_stock` VALUES (17,'005','FI0009',1,NULL,'in',22,36,'IF2023040500002','Panel单层02','11','Panel',1.00,NULL,'22',2,'WareHouse2','WareHouse2',NULL,25,'MO202304030001',NULL,NULL,NULL,NULL,0,1,1,'2023-05-05 03:04:24','2023-05-05 03:04:45',1);
...
INSERT INTO `t_panel` VALUES (35,'P202304210002','PH2345678A1','1133','111',NULL,NULL,NULL,0,1,0,1,'2023-04-27 05:55:37','2023-05-05 02:04:33',1);
...
CREATE TABLE `t_process` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='工序设置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_product_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COMMENT='产品大类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_product_category` VALUES (7,0,'p01','单面板','单面板',0,1,1,'2023-03-28 16:47:00','2023-05-05 01:38:28',1,'0');
...
CREATE TABLE `t_route_and_product_category` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COMMENT='工艺路线与产品大类关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_task` (
  ...
  `ancestors` varchar(255) DEFAULT NULL COMMENT '所有层级父节点',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_task` VALUES (64,'叠板',0,'#0001',25,'MO202304030001','PCB单层',NULL,218,'叠板机01-0001','pin01-0001',21,'钻孔','drill',36,'Panel单层02','IF2023040500002',22,NULL,NULL,50,115,100,NULL,NULL,NULL,NULL,NULL,'2023-04-28 22:00:00',1,'2023-04-29 06:00:00','2023-05-04 16:00:00','DRAFT','#0A1C23',NULL,0,1,1,'2023-04-18 01:55:09','2023-05-05 22:35:25',1,'0');
...
INSERT INTO `t_task` VALUES (78,'Task0001',0,'Task0001',39,'MO202304230001','20230423客户订单',NULL,218,'叠板机01-0001','pin01-0001',21,'钻孔','drill',36,'PCB单层板','IF2023040500002',22,'DDD XXXX DD','Panel',105,110,95,NULL,NULL,41,'001','001','2023-05-05 01:00:00',3,'2023-05-06 01:00:00','2023-05-06 16:00:00','DRAFT','#0A1C23','0',0,1,33,'2023-04-23 02:56:18','2023-05-05 22:35:42',1,'0');
...
INSERT INTO `t_task` VALUES (81,'001',0,'001',50,'MO202304280004','PCB单层','22',218,'叠板机01-0001','pin01-0001',21,'PCB单层','MO202304280004',36,'PCB单层板','IF2023040500002',22,'DDD XXXX DD','Panel',1,NULL,NULL,NULL,NULL,41,'001','001','2023-05-04 06:00:00',1,'2023-05-04 14:00:00','2023-05-12 18:00:00','DRAFT','#0A1C23','0',0,1,1,'2023-05-05 02:16:59','2023-05-05 22:05:35',1,'0');
...
CREATE TABLE `t_unit_measure` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COMMENT='单位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_unit_measure` VALUES (33,'Panel','单层Panel','Y',34,2.0000,'单位',0,1,1,'2023-04-18 22:11:38','2023-05-05 01:34:35',1);
...
CREATE TABLE `t_warehouse` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='仓库表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_work_order` (
  ...
  `ancestors` varchar(255) DEFAULT NULL COMMENT '所有层级父节点',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产工单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_work_order` VALUES (50,'PCB单层',0,'MO202304280004','客户订单','0000000000002',36,'PCB单层板','IF2023040500002',22,'22','DDD XXXX DD','Panel',240,260,113,15,41,'张老板','001','2023-05-12 18:00:00','COMMITED',0,1,1,'2023-05-02 08:38:15','2023-05-05 01:12:26',1,'0');
...
CREATE TABLE `t_workshop` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COMMENT='车间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_workstation` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=233 DEFAULT CHARSET=utf8mb4 COMMENT='工作站表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-06  2:47:03
