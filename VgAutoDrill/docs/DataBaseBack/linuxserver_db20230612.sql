...
CREATE TABLE `sys_menu` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1351 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_check_records` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COMMENT='检验记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_check_records` VALUES (37,144,NULL,'',61,'MO20230612000001','123',NULL,NULL,'-1',NULL,NULL,1,0,1,'2023-06-12 14:17:46',NULL,NULL);
...
CREATE TABLE `t_client` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COMMENT='客户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_device` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='设备管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_device` VALUES (19,'MockAgv04','MockAgv04',NULL,0,0,1,1,'2023-03-07 17:09:12','2023-05-26 01:06:21',1,8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'-1');
...
INSERT INTO `t_device` VALUES (51,'A00','A00',NULL,0,0,1,1,'2023-03-22 23:02:07','2023-03-23 01:17:05',1,7,NULL,NULL,NULL,212,NULL,NULL,NULL,NULL,'3');
INSERT INTO `t_device` VALUES (52,'P00002','P00002',NULL,0,0,1,1,'2023-03-22 23:16:16','2023-03-23 01:36:23',1,7,NULL,NULL,NULL,217,NULL,NULL,NULL,NULL,'4');
INSERT INTO `t_device` VALUES (54,'Q0001','Q0001',NULL,0,0,1,1,'2023-03-23 01:19:33','2023-03-23 02:21:09',1,7,NULL,NULL,NULL,233,NULL,NULL,NULL,NULL,'0');
...
CREATE TABLE `t_device_maintain` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='维护记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_device_maintain` VALUES (7,16,'P0001','P0001','2023-05-16 16:00:00',NULL,'1111111','-1','1111111111111',0,1,1,'2023-05-17 05:22:21',NULL,NULL);
INSERT INTO `t_device_maintain` VALUES (8,14,'MockAgv02','MockAgv02','2023-05-24 02:22:52',NULL,'111','-1','111',0,1,1,'2023-05-23 22:22:32',NULL,NULL);
...
CREATE TABLE `t_drill_work_order` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='钻孔工单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_drill_work_order` VALUES (15,61,'MO20230612000001',36,'IF2023040500002',0.00,0.00,0.00,0.00,2.00,0.00,10000.00,40.00,120.00,0.00,2.00,0,1,1,'2023-06-12 10:07:54','2023-06-12 10:12:19',1);
...
CREATE TABLE `t_feedback` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COMMENT='生产报工记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_feedback` VALUES (55,'2',217,'drill01-0002','钻机01-0002',61,'MO20230612000001','123',22,'drill','钻孔',145,'TO20230612000001',36,'MO20230612000001','123',22,'Panel','DDD XXXX DD',1.00,NULL,NULL,NULL,'yp','yp',NULL,'2023-06-12 00:00:00','123','COMMITED',NULL,0,1,1,'2023-06-12 13:51:00','2023-06-12 14:18:08',1);
...
CREATE TABLE `t_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='物料产品定义表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item_atp_file` VALUES (2,'IF2023040500002','PCB单层板',36,22,'生成0.3475938809395587','ATP0.8527352658673837','string',0,'计量单位模板','\\\\fileServer\\IF200001111\\IF200001111.drl',0,'计量单位模板1','/root/admin1.0/data/dia/板料追溯.xlsx',1,2,1,1,'2023-04-07 07:35:18',0,1,1,'2023-04-07 15:35:28','2023-05-23 03:15:54',1);
...
INSERT INTO `t_item_atp_file` VALUES (44,'IF2023040500002','PCB单层板',36,22,'生成0.03467923884419366','ATP0.09587893362830191',NULL,NULL,'测试1','/root/admin1.0/data/dia/12.docx',NULL,'维嘉2','/root/admin1.0/data/dia/维嘉.txt',2,2,3,1,NULL,0,1,1,'2023-05-04 23:11:14','2023-05-23 03:16:03',1);
...
INSERT INTO `t_item_atp_file_detail` VALUES (9787,2,NULL,NULL,1,0,1,1,'2023-05-22 03:30:07',NULL,NULL);
INSERT INTO `t_item_atp_file_detail` VALUES (9788,2,NULL,NULL,2,0,1,1,'2023-05-22 03:30:07',NULL,NULL);
...
INSERT INTO `t_item_type` VALUES (40,'全自动',1,'IT20230523000003BM',2,NULL,'0,1',0,1,1,'2023-05-05 04:03:54','2023-05-23 03:30:38',1);
INSERT INTO `t_item_type` VALUES (41,'11',4,'IT20230606000001BM',2,NULL,'0,1,4',0,1,1,'2023-05-05 04:06:02','2023-06-12 10:57:12',1);
...
INSERT INTO `t_panel` VALUES (44,'11','11','111','11','1',NULL,NULL,NULL,1,0,1,'2023-05-23 01:50:55',NULL,NULL);
INSERT INTO `t_panel` VALUES (47,'111','111','111','111','1',NULL,NULL,NULL,1,0,1,'2023-05-23 21:56:46',NULL,NULL);
...
CREATE TABLE `t_product_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COMMENT='产品大类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_schedulement` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='调度记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_task` VALUES (143,'',0,NULL,61,'MO20230612000001','123','123',212,'钻机01-0001','drill01-0001',NULL,NULL,'drill',36,'123','MO20230612000001',22,'DDD XXXX DD','Panel',1,1,1,NULL,0,55,'张老板','15200000001','2023-06-12 10:07:54',1,'2023-06-12 10:07:54',NULL,'DRAFT',NULL,NULL,0,1,1,'2023-06-12 10:07:54','2023-06-12 10:12:19',NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (144,'',0,NULL,61,'MO20230612000001','123','123',212,'钻机01-0001','drill01-0001',NULL,NULL,'drill',36,'123','MO20230612000001',22,'DDD XXXX DD','Panel',1,1,1,NULL,0,55,'张老板','15200000001','2023-06-13 10:07:54',1,'2023-06-12 10:07:54',NULL,'DRAFT',NULL,NULL,0,1,1,'2023-06-12 10:07:54','2023-06-12 03:25:20',1,'0',NULL,NULL,NULL,NULL);
INSERT INTO `t_task` VALUES (145,'task000001',0,'TO20230612000001',61,'MO20230612000001','123','123',212,'钻机01-0001','drill01-0001',22,'钻孔','drill',36,'PCB单层板','IF2023040500002',22,'DDD XXXX DD','Panel',4,NULL,NULL,NULL,NULL,55,'15200000001','15200000001','2023-06-13 10:07:54',2,'2023-06-13 02:50:47','2023-06-12 00:00:00','DRAFT','#D22525','1',0,1,1,'2023-06-12 10:50:30','2023-06-12 03:20:58',1,'0',NULL,NULL,NULL,NULL);
INSERT INTO `t_task` VALUES (146,'pin000002',0,'TO20230612000002',57,'拖拽123','拖拽123','123',218,'叠板机01-0001','pin01-0001',21,'叠板','pin',36,'PCB单层板','IF2023040500002',22,'DDD XXXX DD','Panel',1,NULL,NULL,0,0,55,'15200000001','15200000001','2023-06-12 02:53:21',1,'2023-06-12 03:03:21','2023-06-09 00:00:00','DRAFT','#6CD228','0',0,1,1,'2023-06-12 10:52:49',NULL,NULL,'0',NULL,NULL,NULL,NULL);
INSERT INTO `t_task` VALUES (147,'unpin123',0,'TO20230612000003',60,'MO20230611000001','workOrder','abc11',219,'拆板机01-0001','unpin01-0001',23,'拆板','unpin',36,'PCB单层板','IF2023040500002',22,'DDD XXXX DD','Panel',1,NULL,NULL,0,0,55,'15200000001','15200000001','2023-06-12 02:53:44',1,'2023-06-12 03:03:44','2023-06-12 00:00:00','DRAFT','#1849DC','0',0,1,1,'2023-06-12 10:53:10',NULL,NULL,'0',NULL,NULL,NULL,NULL);
...
CREATE TABLE `t_unit_measure` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COMMENT='单位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_vendor` VALUES (47,'15200000001','张老板','铜料板供应',0,0,1,'2023-06-06 16:10:11',NULL,NULL);
...
CREATE TABLE `t_work_order` (
  ...
  `ancestors` varchar(255) DEFAULT NULL COMMENT '所有层级父节点',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产工单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_work_order` VALUES (57,'拖拽123',0,'拖拽123','库存需求',NULL,36,'PCB单层板','IF2023040500002',22,'123','DDD XXXX DD','Panel',2,3,3,3,55,'张老板','15200000001','2023-06-09 00:00:00','DRAFT',0,1,0,'2023-06-12 09:57:35',1,1,'2023-06-09 10:28:15',NULL,NULL,'0');
INSERT INTO `t_work_order` VALUES (60,'workOrder',0,'MO20230611000001','库存需求',NULL,36,'PCB单层板','IF2023040500002',22,'abc11','DDD XXXX DD','Panel',1,1,1,1,55,'张老板','15200000001','2023-06-12 00:00:00','DRAFT',0,0,0,'2023-06-12 09:56:23',1,1,'2023-06-11 21:12:49',NULL,NULL,'0');
INSERT INTO `t_work_order` VALUES (61,'123',0,'MO20230612000001','库存需求','无',36,'PCB单层板','IF2023040500002',22,'123','DDD XXXX DD','Panel',1,1,1,1,55,'张老板','15200000001','2023-06-12 00:00:00','DRAFT',0,1,1,'2023-06-12 10:07:54',1,1,'2023-06-12 09:26:02',NULL,NULL,'0');
...
INSERT INTO `t_workstation` VALUES (212,'drill01-0001','钻机01-0001',9,NULL,'车间02（测试）','',0,1,1,'2023-04-04 02:32:34','2023-05-23 21:31:20',1);
INSERT INTO `t_workstation` VALUES (217,'drill01-0002','钻机01-0002',NULL,NULL,'车间02（测试）',NULL,0,1,1,'2023-04-05 22:37:47','2023-05-23 21:31:14',1);
...
INSERT INTO `t_workstation` VALUES (233,'drill01-0003','钻机01-0003',9,'shop02','车间02（测试）','钻机工作站',0,0,1,'2023-05-09 03:07:07',NULL,NULL);
...
-- Dump completed on 2023-06-12  7:38:01
