...
INSERT INTO `sys_menu` VALUES (1158,'DRILLAMIN','仓储管理',0,'tree','wm','#',1,NULL,NULL,50,0,0,1,'2023-04-01 02:50:34','2023-06-21 15:38:23',1);
...
CREATE TABLE `t_check_records` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='检验记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_check_records` VALUES (59,360,'TO20230621000008','TO20230621000008',75,'MO20230621000001','物料',NULL,NULL,'-1',NULL,NULL,1,0,1,'2023-06-21 15:28:02',NULL,NULL);
...
CREATE TABLE `t_cutter_config_detail` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='钻孔刀具参数明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_device` VALUES (15,'MockDrill01','MockDrill01',NULL,0,0,1,1,'2023-03-03 00:34:24','2023-03-22 07:52:58',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'0');
...
INSERT INTO `t_device` VALUES (23,'MockDrill02','MockDrill02',NULL,0,0,1,1,'2023-03-13 13:54:18','2023-03-22 07:52:58',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'0');
INSERT INTO `t_device` VALUES (24,'MockDrill03','MockDrill03',NULL,0,0,1,1,'2023-03-14 08:48:10','2023-03-20 11:46:56',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'2');
...
INSERT INTO `t_device` VALUES (26,'MockDrill04','MockDrill04',NULL,0,0,1,1,'2023-03-14 09:22:53','2023-03-20 11:46:56',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'1');
INSERT INTO `t_device` VALUES (27,'MockDrill05','MockDrill05',NULL,0,0,1,1,'2023-03-14 09:22:54','2023-03-14 11:21:03',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'0');
INSERT INTO `t_device` VALUES (28,'MockDrill06','MockDrill06',NULL,0,0,1,1,'2023-03-14 09:22:54','2023-03-14 11:21:02',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'2');
...
INSERT INTO `t_device` VALUES (31,'vegaDrill001','vegaDrill001',NULL,0,0,1,1,'2023-03-14 16:18:04','2023-03-14 16:27:45',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'2');
...
INSERT INTO `t_device` VALUES (33,'vegaDrill0601','vegaDrill0601',NULL,0,0,1,1,'2023-03-14 16:28:35','2023-03-14 16:33:37',NULL,7,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,'4');
...
INSERT INTO `t_device` VALUES (42,'Processed1000122','Processed1000122',NULL,0,0,1,1,'2023-03-15 16:21:35','2023-06-21 15:22:37',1,17,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,'1');
...
INSERT INTO `t_device_maintain` VALUES (7,16,'drill01-0002','钻机01-0002','2023-05-17 00:00:00',NULL,'1111111','1','1111111111111',0,1,1,'2023-05-17 05:22:21','2023-06-20 16:36:56',1);
...
INSERT INTO `t_device_maintain` VALUES (10,13,'agv01','agv01','2023-06-20 00:00:00',NULL,'111',NULL,'11111',0,1,1,'2023-06-20 16:00:04',NULL,NULL);
INSERT INTO `t_device_maintain` VALUES (11,13,'agv01','agv01','2023-06-20 16:10:42',0,'string','0','1111',0,1,1,'2023-06-20 16:01:01','2023-06-20 16:36:50',1);
...
CREATE TABLE `t_device_maintain_detail` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='设备维护明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_device_subject` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8mb4 COMMENT='设备点检项目模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_drill_work_order` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COMMENT='钻孔工单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_drill_work_order` VALUES (40,75,'MO20230621000001',67,'IF20230620000002A1',2.00,144.00,72.00,6.00,12.00,12.00,20001.00,81.00,972.00,0.00,2.00,0,1,1,'2023-06-21 15:02:01',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='编码生成规则';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_encode_build_rules` VALUES (1,'UNITMEASURE_CODE','计量单位编码','JL',6,1,'','',0,1,1,'2023-05-18 02:58:43','2023-06-19 15:51:11',1);
...
INSERT INTO `t_encode_build_rules` VALUES (10,'WAREHOUSE_CODE','仓库编码','WH',6,1,NULL,'',0,1,1,'2023-05-18 02:58:43',NULL,NULL);
...
CREATE TABLE `t_feedback` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8mb4 COMMENT='生产报工记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_feedback` VALUES (72,'自行报工',212,'drill01-0001','钻机01-0001',75,'MO20230621000001','物料',22,'drill','钻孔',354,'TO20230621000002',67,'MO20230621000001','物料',40,'叠板2层','叠板数2',0.00,30.00,14.00,16.00,'yp1',NULL,NULL,'2023-06-21 00:00:00',NULL,'DRAFT',NULL,0,1,1,'2023-06-21 15:20:35',NULL,NULL);
...
CREATE TABLE `t_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='物料产品定义表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item` VALUES (36,'PCB单层板',0,'IF2023040500002','DDD XXXX DD','Panel',2,22,'0',0,1,1,'2023-04-05 01:25:38','2023-04-20 04:44:00',1,81,'P08-01','高速电路板--客户001指定',NULL,NULL,'WareHouse3');
...
INSERT INTO `t_item` VALUES (68,'板材单钻孔（叠板数2）',0,'IF20230620000005A1','叠板数2','叠板2层',2,40,'0',0,1,1,'2023-06-20 14:50:49',NULL,NULL,74,'P02','双面板',NULL,NULL,'成品一库');
...
CREATE TABLE `t_item_atp_file` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='ATP文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item_atp_file` VALUES (44,'IF2023040500002','PCB单层板',36,22,'生成0.9681125159109065','ATP0.7679197349316425',NULL,NULL,'测试1','/root/admin1.0/data/dia/12.docx',NULL,'维嘉2','/root/admin1.0/data/dia/维嘉.txt',2,2,3,1,NULL,0,1,1,'2023-05-04 23:11:14','2023-06-20 09:40:58',32);
INSERT INTO `t_item_atp_file` VALUES (45,'IF20230620000005A1','板材单钻孔（叠板数2）',68,40,'生成0.7154582632220308','ATP0.34544540105081634',NULL,NULL,'1','/root/admin1.0/data/dia/维嘉.txt',NULL,'12','/root/admin1.0/data/dia/ATP文件.docx',1,1,4,1,NULL,0,1,1,'2023-05-04 23:31:47','2023-06-21 16:39:02',1);
...
CREATE TABLE `t_item_atp_file_detail` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10389 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='ATP文件明细';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_item_atp_file_detail` VALUES (9759,45,'22',0.50,3,0,0,1,'2023-05-04 23:31:47','2023-06-19 17:27:59',1);
INSERT INTO `t_item_atp_file_detail` VALUES (9760,45,'22',0.50,4,0,0,1,'2023-05-04 23:31:47','2023-06-19 17:27:59',1);
...
CREATE TABLE `t_item_drill_file` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='钻带参数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_material_stock` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='库存记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_material_stock` VALUES (29,'kc---0001','001',2,3,'in',22,36,'IF2023040500002','PCB单层板','DDD XXXX DD','Panel',3.00,NULL,'123',2,'WareHouse2','WareHouse2',NULL,57,'拖拽123',NULL,NULL,NULL,NULL,0,1,1,'2023-06-19 00:58:00',NULL,NULL);
INSERT INTO `t_material_stock` VALUES (30,'i202300000000','4567890',1,NULL,'in',4,64,'IF20230612000001A1','wu','111','叠板2层',6.00,NULL,'无',14,'WareHouse','WareHouse',NULL,64,'MO20230615000001',NULL,NULL,NULL,NULL,0,1,1,'2023-06-19 15:47:22',NULL,NULL);
...
INSERT INTO `t_process` VALUES (22,'钻孔','drill','',0,1,1,'2023-05-10 02:05:50','2023-06-20 10:00:16',32);
...
INSERT INTO `t_product_category` VALUES (72,0,'P01','单面板','单面板',0,0,1,'2023-05-09 03:40:40','2023-06-20 08:52:12',1,'0');
...
INSERT INTO `t_route` VALUES (3,'A0001','工艺路线A0001','叠板+钻孔+拆板',NULL,1,0,1,'2023-04-05 01:57:50','2023-06-20 10:04:25',32);
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='工艺路线与工序关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_route_and_process` VALUES (9,3,22,2,'1','#F31800',840,'0',0,0,0,1,'2023-04-07 02:40:29','2023-06-20 10:03:30',32);
INSERT INTO `t_route_and_process` VALUES (11,2,22,2,'1','#00AEF3',40,'0',3,1,0,1,'2023-04-10 22:58:49','2023-06-21 13:59:04',1);
INSERT INTO `t_route_and_process` VALUES (12,2,21,1,'0','#0A1C23',60,'0',2,1,0,1,'2023-04-10 22:59:09','2023-06-21 13:58:55',1);
...
INSERT INTO `t_route_and_process` VALUES (33,2,23,3,'0','#853C3C',10,'1',3,1,0,1,'2023-06-13 21:44:55','2023-06-21 14:00:43',1);
INSERT INTO `t_route_and_process` VALUES (34,3,23,3,'0','#704848',120,'0',1,1,0,1,'2023-06-16 04:42:46','2023-06-16 04:47:17',1);
INSERT INTO `t_route_and_process` VALUES (38,3,21,1,'0','#D33737',120,'0',0,1,0,1,'2023-06-16 04:54:26','2023-06-20 10:04:14',32);
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COMMENT='工艺路线与产品大类关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_route_and_product_category` VALUES (44,3,74,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (45,3,75,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (46,3,76,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (47,3,77,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (48,3,78,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (49,3,79,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (50,3,80,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
INSERT INTO `t_route_and_product_category` VALUES (51,3,81,1,0,1,'2023-06-20 16:50:13',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COMMENT='工序与工作站关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_schedulement` VALUES (3,NULL,'MockDrill01','MockAgv02',NULL,'1','17',NULL,NULL,0,0,2,1,'2023-06-12 13:25:38','2023-06-12 13:27:10',1);
INSERT INTO `t_schedulement` VALUES (4,NULL,'MockDrill02','MockAgv02',NULL,'18','19',NULL,NULL,0,0,1,1,'2023-06-12 13:25:48',NULL,NULL);
INSERT INTO `t_schedulement` VALUES (5,NULL,'MockDrill03','MockAgv02',NULL,'20','23',NULL,NULL,NULL,0,-1,1,'2023-06-12 23:36:46',NULL,NULL);
...
INSERT INTO `t_subject` VALUES (6,'总进气压',0,'1','点检','','(6-7)kg/cm²','0',0,1,1,'2023-06-21 15:55:08','2023-06-21 16:03:53',1);
...
CREATE TABLE `t_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=367 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_task` VALUES (354,'TO20230621000002',0,'TO20230621000002',75,'MO20230621000001','物料',NULL,212,'钻机01-0001','drill01-0001',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (355,'TO20230621000003',0,'TO20230621000003',75,'MO20230621000001','物料',NULL,217,'钻机01-0002','drill01-0002',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (356,'TO20230621000004',0,'TO20230621000004',75,'MO20230621000001','物料',NULL,233,'钻机01-0003','drill01-0003',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (357,'TO20230621000005',0,'TO20230621000005',75,'MO20230621000001','物料',NULL,212,'钻机01-0001','drill01-0001',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (358,'TO20230621000006',0,'TO20230621000006',75,'MO20230621000001','物料',NULL,217,'钻机01-0002','drill01-0002',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (359,'TO20230621000007',0,'TO20230621000007',75,'MO20230621000001','物料',NULL,233,'钻机01-0003','drill01-0003',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (360,'TO20230621000008',0,'TO20230621000008',75,'MO20230621000001','物料',NULL,212,'钻机01-0001','drill01-0001',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (361,'TO20230621000009',0,'TO20230621000009',75,'MO20230621000001','物料',NULL,217,'钻机01-0002','drill01-0002',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (362,'TO20230621000010',0,'TO20230621000010',75,'MO20230621000001','物料',NULL,233,'钻机01-0003','drill01-0003',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (363,'TO20230621000011',0,'TO20230621000011',75,'MO20230621000001','物料',NULL,212,'钻机01-0001','drill01-0001',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (364,'TO20230621000012',0,'TO20230621000012',75,'MO20230621000001','物料',NULL,217,'钻机01-0002','drill01-0002',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (365,'TO20230621000013',0,'TO20230621000013',75,'MO20230621000001','物料',NULL,233,'钻机01-0003','drill01-0003',22,'钻孔','drill',67,'物料','MO20230621000001',40,'叠板数2','叠板2层',128,144,0,NULL,0,56,'王老板','KH20230613000001','2023-06-21 15:02:01',1,'2023-06-21 15:02:01',NULL,'DRAFT','#F31800',NULL,0,1,1,'2023-06-21 15:02:01',NULL,NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO `t_task` VALUES (366,'TO20230621000015',0,'TO20230621000015',75,'MO20230621000001','物料',NULL,218,'叠板机01-0001','pin01-0001',21,'叠板','pin',67,'板材单钻孔（叠板数2）','IF20230620000002A1',40,'叠板数2','叠板2层',6,NULL,NULL,0,0,56,'KH20230613000001','KH20230613000001','2023-06-21 16:26:57',120,'2023-06-22 04:26:57','2023-06-27 00:00:00','DRAFT','#D33737','0',0,1,1,'2023-06-21 16:26:32',NULL,NULL,'0',NULL,NULL,NULL,NULL);
...
CREATE TABLE `t_unit_measure` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8mb4 COMMENT='单位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_unit_measure` VALUES (34,'叠板2层','叠板2层','N',74,2.0000,NULL,0,1,1,'2023-04-18 22:13:06','2023-06-21 13:45:02',1);
...
INSERT INTO `t_warehouse` VALUES (14,'WH01','成品一库','钻机01-0003','','',0,1,1,'2023-04-18 23:36:14','2023-06-20 10:30:46',32);
...
CREATE TABLE `t_work_order` (
  ...
  `ancestors` varchar(255) DEFAULT NULL COMMENT '所有层级父节点',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='生产工单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_work_order` VALUES (75,'物料',0,'MO20230621000001','客户订单',NULL,67,'板材单钻孔（叠板数2）','IF20230620000002A1',40,NULL,'叠板数2','叠板2层',128,144,0,6,56,'王老板','KH20230613000001','2023-06-27 00:00:00','COMMITED',0,1,1,'2023-06-21 15:02:01',2.00,72.00,20001.00,1,1,'2023-06-21 14:05:04','2023-06-21 14:14:50',1,'0');
...
CREATE TABLE `t_workstation` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=244 DEFAULT CHARSET=utf8mb4 COMMENT='工作站表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-21  9:22:15
