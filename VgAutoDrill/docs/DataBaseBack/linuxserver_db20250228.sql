...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8mb4 COMMENT='系统配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES (126,'ChongDaGenAgvSchedulingTaskUrl','http://ip:port/','string','下发海康任务(崇达)',NULL,'下发海康任务(崇达)',0,1,1,'2024-11-26 16:35:49',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (127,'ChongDaQueryAgvStatusUrl','http://ip:port/','string','查询海康AGV状态(崇达)',NULL,'查询海康AGV状态(崇达)',0,1,1,'2024-11-26 16:39:13',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (128,'ChongDaSyncMapDatasUrl','http://ip:port/','string','地图位置信息同步(崇达)',NULL,'地图位置信息同步(崇达)',0,1,1,'2024-11-26 16:43:17',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (129,'ChongDaQueryTaskStatusUrl','http://ip:port/','string','查询任务状态(崇达)',NULL,'查询任务状态(崇达)',0,1,1,'2024-11-26 16:45:12',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (130,'ChongDaContinueTaskUrl','http://ip:port/','string','继续执行任务(崇达)',NULL,'继续执行任务(崇达)',0,1,1,'2024-11-26 16:46:44',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (131,'ChongDaCancelTaskUrl','http://ip:port/','string','取消任务(崇达)',NULL,'取消任务(崇达)',0,1,1,'2024-11-26 16:47:53',NULL,NULL,0,NULL,0,'30');
INSERT INTO `sys_config` VALUES (132,'EnablePropertiesFlusher','false','bool','是否开启定时保存设备属性信息',NULL,'是否开启定时保存设备属性信息',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (133,'PropertiesFlusherInterval','10','int','定时保存设备属性信息时间间隔',NULL,'定时保存设备属性信息时间间隔(单位分钟)',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (134,'EnablePanelFlusher','false','bool','是否开启定时保存设备板料信息',NULL,'是否开启定时保存设备板料信息',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (135,'PanelFlusherInterval','10','int','定时保存设备板料信息时间间隔',NULL,'定时保存设备板料信息时间间隔(单位分钟)',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (136,'EnableCutterFlusher','false','bool','是否开启定时保存设备刀具信息',NULL,'是否开启定时保存设备刀具信息',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (137,'CutterFlusherInterval','10','int','定时保存设备刀具信息时间间隔',NULL,'定时保存设备刀具信息时间间隔(单位分钟)',0,1,1,'2024-12-02 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (138,'WipMinDrilledTrackOutNum','10','int','线边仓熟料最少自动转出数量',NULL,'线边仓熟料最少自动转出数量',0,1,1,'2023-11-02 11:40:10',NULL,NULL,10,NULL,0,'1');
INSERT INTO `sys_config` VALUES (139,'WipAutoTrackOutSilo','false','bool','当线边仓料仓中没有钻机中相同的料号时是否立即转出',NULL,'当线边仓料仓中没有钻机中相同的料号时是否立即转出',0,1,1,'2024-11-08 00:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (140,'WipMaxPartitionEmptySiloNum','2','int','线边仓最多空料仓的数量',NULL,'线边仓最多空料仓的数量',0,1,1,'2023-11-06 11:40:10',NULL,NULL,10,NULL,0,'1');
INSERT INTO `sys_config` VALUES (141,'WipMinPartitionEmptySiloNum','1','int','线边仓最少空料仓的数量',NULL,'线边仓最少空料仓的数量',0,1,1,'2023-11-06 11:40:10',NULL,NULL,10,NULL,0,'1');
INSERT INTO `sys_config` VALUES (142,'WipCountOfEmptyForkAtLeast','3','int','线边仓最少空库位数量',NULL,'线边仓最少空库位数量，默认1',0,1,1,'2024-10-25 16:00:22',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (143,'WipMinFirstDrilledTrackOutNum','10','int','线边仓首件最少自动转出数量',NULL,'线边仓首件最少自动转出数量',0,1,1,'2023-11-02 11:40:10',NULL,NULL,10,NULL,0,'1');
INSERT INTO `sys_config` VALUES (144,'UndrilledItemOccupyLocationIdleTimeout','30','int','生料占用库位超时时间时长(秒)',NULL,'生料占用库位超时时间时长(秒)',0,1,1,'2023-11-05 11:40:10',NULL,NULL,10,NULL,0,'1');
INSERT INTO `sys_config` VALUES (145,'MonitorTaskCompleteTimeOut','20','int','监控任务超时时间',NULL,'监控任务完成超时时间(单位分钟)',0,1,1,'2024-12-17 11:23:00',NULL,NULL,1,NULL,0,'30');
INSERT INTO `sys_config` VALUES (146,'MonitorTaskFailTimeOut','20','int','监控任务超时时间',NULL,'监控任务完成超时时间(单位分钟)',0,1,1,'2024-12-17 11:23:00',NULL,NULL,1,NULL,0,'30');
INSERT INTO `sys_config` VALUES (147,'HiktaskTyp','WJ02','string','海康接口任务类型模板',NULL,'海康接口任务类型模板',0,1,1,'2024-12-17 11:23:00',NULL,NULL,1,NULL,0,'30');
INSERT INTO `sys_config` VALUES (148,'PropertiesFlusherAllowedDevices','','string','允许属性上报试运行的设备列表',NULL,'允许属性上报试运行的设备列表，none-限制；空白时，相当于禁用属性上报；drill01,drill02, 用逗号分割符号，分割多个设备列表',0,1,1,'2024-12-19 16:48:00',NULL,NULL,1,NULL,0,'10');
INSERT INTO `sys_config` VALUES (149,'Sailings','0-8:00|2-20:00','string','班次',NULL,'班次(0-白班开始时间|1-中班开始时间|2-夜班开始时间) 用|分割符号，分割多个班次',0,1,1,'2025-01-02 16:48:00',NULL,NULL,1,NULL,0,'1');
INSERT INTO `sys_config` VALUES (150,'JingWangTransferDrillFileEnable_WorkOrder','false','bool','人工录入工单是否开启获取钻带参数',NULL,'人工录入工单是否开启获取钻带参数',0,1,1,'2025-01-06 16:00:22',NULL,NULL,1,NULL,0,'2');
INSERT INTO `sys_config` VALUES (151,'XianJinSendCommandDelay','1','int','先进下发完成上料信息，延迟时长（秒）',NULL,'先进下发完成上料信息，延迟时长（秒）',0,1,1,'2025-01-09 00:00:22',NULL,NULL,1,NULL,0,'4');
INSERT INTO `sys_config` VALUES (152,'JingWangVerifyItemNum_WorkOrder','false','bool','添加工单，校验物料数量是否超过自动工单的数量',NULL,'添加工单，校验物料数量是否超过自动工单的数量',0,1,1,'2025-01-13 10:40:22',NULL,NULL,1,NULL,0,'2');
INSERT INTO `sys_config` VALUES (153,'StockInfoQueryDrillAreaCode','J03-DR-IN-Schedule','string','库存信息钻孔区域编码',NULL,'库存信息钻孔区域编码',0,1,1,'2025-02-19 16:00:22',NULL,NULL,0,NULL,0,'2');
INSERT INTO `sys_config` VALUES (154,'RateRecordSummaryRetainTime','6','int','稼动率汇总表数据，保留时长（单位：月）',NULL,'稼动率汇总表数据，保留时长（单位：月）',0,1,1,'2025-02-21 10:24:22',NULL,NULL,0,NULL,0,'2');
INSERT INTO `sys_config` VALUES (155,'RateFactorRetainTime','1','int','稼动率明细数据，保留时长（单位：月）',NULL,'稼动率明细数据，保留时长（单位：月）',0,1,1,'2025-02-21 10:24:22',NULL,NULL,0,NULL,0,'2');
...
CREATE TABLE `sys_menu` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1682 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_alarm` (
  ...
  `alarm_kind` int(11) DEFAULT NULL COMMENT '告警分类',
  `alarm_content` varchar(500) DEFAULT NULL COMMENT '告警内容',
  `token` varchar(100) DEFAULT NULL COMMENT '处理令牌',
  `location_code` varchar(100) DEFAULT NULL COMMENT '库位编码',
  `partition_code` varchar(100) DEFAULT NULL COMMENT '区域编码',
  PRIMARY KEY (`id`) USING BTREE
...
--
-- Table structure for table `t_device_records`
--

DROP TABLE IF EXISTS `t_device_records`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `t_device_records`
--

LOCK TABLES `t_device_records` WRITE;
/*!40000 ALTER TABLE `t_device_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_device_records` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_device_records_summary`
--

DROP TABLE IF EXISTS `t_device_records_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_device_records_summary` (
  ...
  `wait_time` int(11) DEFAULT NULL COMMENT '等待时间',
  `error_time` int(11) DEFAULT NULL COMMENT '异常时间',
  `open_time` int(11) DEFAULT NULL COMMENT '开机时间',
  `duty` int(11) DEFAULT NULL COMMENT '稼动率',
  `end_to_start_time` int(11) DEFAULT NULL COMMENT '结束到开始总时间',
  `collect_clear_time` int(11) DEFAULT NULL COMMENT '清洗夹头总时间',
  `date_string` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '数据日期',
  `sailings` int(11) NOT NULL DEFAULT '0' COMMENT '班次(0-白班，1-中班，2-夜班)',
  `without_task_time` int(11) DEFAULT NULL COMMENT '无任务时长',
  `tool_life_expored_time` int(11) DEFAULT NULL COMMENT '刀具异常时长',
  `without_drill_file_time` int(11) DEFAULT NULL COMMENT '没有加载钻带参数时长',
  `without_panel_time` int(11) DEFAULT NULL COMMENT '无板料生产时长',
  `alarm_time` int(11) DEFAULT NULL COMMENT '设备异常时长',
  `run_time` int(11) DEFAULT NULL COMMENT '设备运行时长',
  `buffer_no_board_time` int(11) DEFAULT NULL COMMENT 'Buffer无生料时长',
  `buffer_clinker_exist_time` int(11) DEFAULT NULL COMMENT 'Buffer有熟料时长',
  `device_disable_time` int(11) DEFAULT NULL COMMENT '设备禁用时长',
  `buffer_raw_complete_time` int(11) DEFAULT NULL COMMENT 'Buffer有板到上板完成时长',
  `buffer_raw_exist_to_run_time` int(11) DEFAULT NULL COMMENT 'Buffer上板完成到开始打板时长',
  `buffer_automatic_time` int(11) DEFAULT NULL COMMENT 'Buffer自动时长',
  `drill_board_direction_time` int(11) DEFAULT NULL COMMENT '板方向检测时长',
  `drill_test_pin_time` int(11) DEFAULT NULL COMMENT 'pin检测时长',
  `drill_tool_evaluation_time` int(11) DEFAULT NULL COMMENT '刀具检测时长',
  `buffer_manual_time` int(11) DEFAULT NULL COMMENT 'Buffer手动时长',
  `theory_duty` int(11) DEFAULT NULL COMMENT '理论稼动率',
  `duty_rate` int(11) DEFAULT NULL COMMENT '稼动率达成率',
  `tool_life_expored_count` int(11) DEFAULT NULL COMMENT '刀具寿命报警次数',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `create_time` (`create_time`),
  KEY `device_code` (`device_code`)
...
--
-- Dumping data for table `t_device_records_summary`
--

LOCK TABLES `t_device_records_summary` WRITE;
/*!40000 ALTER TABLE `t_device_records_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_device_records_summary` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `t_drill_rate_factor`
--

DROP TABLE IF EXISTS `t_drill_rate_factor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `t_drill_rate_factor`
--

LOCK TABLES `t_drill_rate_factor` WRITE;
/*!40000 ALTER TABLE `t_drill_rate_factor` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_drill_rate_factor` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `t_external_work_order` (
  ...
  `is_send_move_info` tinyint(4) DEFAULT '0' COMMENT '是否下发转仓命令',
  `lot_stock_num` decimal(20,0) DEFAULT NULL COMMENT '物料库存数量',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_item` (
  ...
  `spec_group` varchar(100) DEFAULT NULL COMMENT '工艺分组',
  `before_drill_file_path` varchar(500) DEFAULT NULL COMMENT '转换前钻带路径',
  `after_drill_file_path` varchar(500) DEFAULT NULL COMMENT '转换后钻带路径',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `code_UNIQUE` (`code`)
...
CREATE TABLE `t_rack` (
  ...
  `position_code` varchar(200) DEFAULT NULL COMMENT '位置码',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_schedule` (
  ...
  `canceled_time` datetime DEFAULT NULL COMMENT '取消计划时间',
  `routing_key` varchar(100) DEFAULT NULL COMMENT '主叫设备的route key',
  `remark` mediumtext CHARACTER SET utf8 COMMENT '备注',
...
CREATE TABLE `t_schedule_log` (
  ...
  `spindle` int(11) DEFAULT NULL COMMENT '轴号',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `t_transportation_task` (
  ...
  `master_device_kind` varchar(100) DEFAULT NULL,
  `agv_kind` varchar(100) DEFAULT NULL,
  `allocate_agv` varchar(100) DEFAULT NULL,
  `hk_response_key` varchar(100) DEFAULT NULL COMMENT '海康任务号',
...
CREATE TABLE `t_warehouse` (
  ...
  `pre_book_time` datetime DEFAULT NULL COMMENT '预约时间',
  `partition_kind` tinyint(4) NOT NULL COMMENT '分区类别,默认0未知，1私有分区，2公共分区',
  PRIMARY KEY (`id`),
  UNIQUE KEY `code_UNIQUE` (`code`)
...
INSERT INTO `t_warehouse` VALUES (1,'000','全部',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 10:49:44',1,NULL,NULL,0,'0',NULL,NULL,1);
INSERT INTO `t_warehouse` VALUES (2,'PartPanelShelf','线边仓',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-23 10:39:28',1,NULL,NULL,1,'0,1',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (3,'PartPin','上Pin',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 11:20:28',1,NULL,NULL,1,'0,1',NULL,NULL,1);
INSERT INTO `t_warehouse` VALUES (4,'PartUnpin','下Pin',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-10-12 14:23:30',59,NULL,NULL,1,'0,1',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (5,'PartPanelFork','中转区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-09-29 16:14:29',1,NULL,NULL,1,'0,1',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (6,'PartPanelShelf-Raw','生料区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 09:42:17',NULL,NULL,NULL,2,'0,1,2',NULL,NULL,1);
INSERT INTO `t_warehouse` VALUES (7,'PartPanelShelf-Clinker','熟料区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 09:42:17',NULL,NULL,NULL,2,'0,1,2',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (8,'PartPin-001','上Pin一区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 09:42:17',NULL,NULL,NULL,3,'0,1,3',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (9,'PartPin-002','上Pin二区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 09:42:17',NULL,NULL,NULL,3,'0,1,3',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (10,'PartUnpin-001','下Pin一区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-08 09:42:17',NULL,NULL,NULL,4,'0,1,4',NULL,NULL,2);
INSERT INTO `t_warehouse` VALUES (11,'PartUnpin-002','下Pin二区',NULL,NULL,'',0,0,1,'2024-08-08 09:42:17','2024-09-19 15:27:33',1,NULL,NULL,4,'0,1,4',NULL,NULL,0);
INSERT INTO `t_warehouse` VALUES (12,'PartPanelFork-Raw','生料中转区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-10-12 14:23:21',59,NULL,NULL,5,'0,1,5','',NULL,0);
INSERT INTO `t_warehouse` VALUES (13,'PartPanelFork-Clinker','熟料中转区',NULL,NULL,'',0,1,1,'2024-08-08 09:42:17','2024-08-09 14:26:18',1,NULL,NULL,5,'0,1,5',NULL,NULL,2);
...
CREATE TABLE `t_work_order_alter_log` (
  ...
  `modifier_id` int(11) DEFAULT NULL COMMENT '修改人Id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `work_order_code` (`work_order_code`),
  KEY `device_code` (`device_code`),
...
-- Dump completed on 2025-02-28 10:24:05
