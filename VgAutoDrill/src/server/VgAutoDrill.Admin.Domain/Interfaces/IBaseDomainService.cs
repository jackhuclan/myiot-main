...
namespace VgAutoDrill.Admin.Domain.Interfaces
{
    public interface IBaseDomainService<T> where T : class
    {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        Task<bool> BulkDelete(List<T> list);
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        Task<bool> BulkUpdate(List<T> list);
        /// <summary>
        /// 根据手写条件更新
        /// </summary>
        /// <param name="model"></param>
        ...
        /// <param name="strWhere"></param>
        /// <returns></returns>
        Task<bool> UpdateAsync(Expression<Func<T, T>> columns, Expression<Func<T, bool>> strWhere);
