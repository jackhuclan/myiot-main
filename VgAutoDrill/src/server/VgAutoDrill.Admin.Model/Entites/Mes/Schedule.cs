...
namespace VgAutoDrill.Admin.Model.Entites.Mes
{
    ...
    public class Schedule : BaseEntity
    {
        ...
        public virtual InteractionSequence? InteractionSequence { get; set; } = (InteractionSequence)8;
        ...
        /// 关联的库位Panels信息
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(ScheduleLocationPanel.ScheduleId), nameof(Id))]
        public List<ScheduleLocationPanel>? LocationPanels { get; private set; }
        ...
        /// 关联的库位Panels信息赋值
        /// </summary>
        /// <param name="locationPanels"></param>
        public void SetScheduleLocationPanel(List<ScheduleLocationPanel> locationPanels)
        {
