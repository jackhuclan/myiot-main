...
{
    public class BaseDtoWithTreeDto : GeneralBaseDtoWithParentId, IDtoWithTree
    {
    ...
    public abstract class GeneralBaseDtoWithParentId : BaseDto
    {
        /// <summary>
        /// 名称
        /// </summary>
    ...
    public interface IDtoWithTree : IDtoOnlyId
    {
        /// <summary>
        /// 名称
        /// </summary>
