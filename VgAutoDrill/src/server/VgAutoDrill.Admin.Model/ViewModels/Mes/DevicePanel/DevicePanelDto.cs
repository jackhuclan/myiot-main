...
{
    public class DevicePanelDto : BaseDto
    {
        /// <summary>
        /// 设备编号
        /// </summary>
        ...
        /// 板料二维码
        /// </summary>
        public virtual string PanelCode { get; set; } = string.Empty;
        ...
        /// Lot二维码
        /// </summary>
        public virtual string LotId { get; set; } = string.Empty;

        /// <summary>
        /// 批次号
        /// </summary>
        public virtual string BatchCode { get; set; } = string.Empty;
