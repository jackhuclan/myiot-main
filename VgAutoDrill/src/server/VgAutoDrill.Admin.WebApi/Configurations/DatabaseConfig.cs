...
public static class DatabaseConfig
{
    public static void AddDatabaseConfiguration(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var dbstring = AppSettingsHelper.GetContent<string>(new string[] { "ConnectionStrings", "VgAutoDrillAuthDB" });
        var slave1 = AppSettingsHelper.GetContent<string>(new string[] { "ConnectionStrings", "VgAutoDrillSlave1" });
        var slave2 = AppSettingsHelper.GetContent<string>(new string[] { "ConnectionStrings", "VgAutoDrillSlave2" });
