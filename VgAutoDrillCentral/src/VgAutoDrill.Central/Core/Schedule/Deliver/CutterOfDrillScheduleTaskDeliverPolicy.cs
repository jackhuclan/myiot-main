...
internal class CutterOfDrillScheduleTaskDeliverPolicy : IScheduleTaskDeliverPolicy
{
    private readonly ILogger<CutterOfDrillScheduleTaskDeliverPolicy> _logger;
    ...
    public CutterOfDrillScheduleTaskDeliverPolicy(IServiceProvider serviceProvider)
    {
        _logger = serviceProvider.GetRequiredService<ILogger<CutterOfDrillScheduleTaskDeliverPolicy>>();
