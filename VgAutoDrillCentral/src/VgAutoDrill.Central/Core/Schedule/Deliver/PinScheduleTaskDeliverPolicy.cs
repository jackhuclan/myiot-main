...
internal class PinScheduleTaskDeliverPolicy : PinAndUnpinBaseDeliverPolicy, IScheduleTaskDeliverPolicy
{
    private readonly ILogger<PinScheduleTaskDeliverPolicy> _logger;
    private readonly IScheduleTaskManager _scheduleTaskManager;
    private readonly IDeviceManager _deviceManager;

    public PinScheduleTaskDeliverPolicy(IServiceProvider serviceProvider) : base(serviceProvider)
    {
        _logger = serviceProvider.GetRequiredService<ILogger<PinScheduleTaskDeliverPolicy>>();
    ...
    public async Task<AgvAllocationResult> DeliverScheduleTask(DeliverScheduleTaskRequirement scheduleTaskRequirement)
    {
        ...
        _logger.LogWarning($"Pin PrepareScheduleTask，开始分配,current eventTraceId:{eventRequest.TraceId},source device:{eventRequest.DeviceId}");
