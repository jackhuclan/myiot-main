...
/// 空料仓从中转位拉到线边仓
/// </summary>
public class EmptyBoxFromForkToWipHandler
{
    private readonly ILogger<EmptyBoxFromForkToWipHandler> _logger;
    ...
    public EmptyBoxFromForkToWipHandler(ILogger<EmptyBoxFromForkToWipHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,开始-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        string message = "空料仓:中转位->线边仓，离开中转位,下发完成信息";
        string operationName = "EmptyBoxFromForkToWipHandler";
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,结束-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,开始-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromForkToWipHandler,结束-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
    }
}
