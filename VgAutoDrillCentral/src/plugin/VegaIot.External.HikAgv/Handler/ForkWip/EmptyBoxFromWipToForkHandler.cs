...
/// 空料仓从线边仓拉到中转位
/// </summary>
public class EmptyBoxFromWipToForkHandler
{
    private readonly ILogger<EmptyBoxFromWipToForkHandler> _logger;
    ...
    public EmptyBoxFromWipToForkHandler(ILogger<EmptyBoxFromWipToForkHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,开始-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        string message = "空料仓:线边仓->中转位，离开线边仓,下发完成信息";
        string operationName = "EmptyBoxFromWipToForkHandler";
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,结束-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,开始-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromWipToForkHandler,结束-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
    }
}
