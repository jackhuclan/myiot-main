...
/// 生料从线边仓拉到中转位
/// </summary>
public class UndrilledFromWipToForkHandler
{
    private readonly ILogger<UndrilledFromWipToForkHandler> _logger;
    ...
    public UndrilledFromWipToForkHandler(ILogger<UndrilledFromWipToForkHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,开始-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        string message = "生料:线边仓->中转位，离开线边仓,下发完成信息";
        string operationName = "UndrilledFromWipToForkHandler";
        ...
        {
            TransferJobId = agvTask.Id,
            Message = $"车辆已到达，离开【生料】线边仓，结束-执行第一段任务."
        });

        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,结束-执行第一段任务，料仓任务:{agvTask.Id}.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,开始-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
        ...
        {
            TransferJobId = agvTask.Id,
            Message = $"车辆已到达，离开中转位，结束-执行第二段任务."
        });
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromWipToForkHandler,结束-执行第二段任务，料仓任务:{agvTask.Id}.\r\n");
    }
}
