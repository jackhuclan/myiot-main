...
internal class HandleAgvOutBinTask
{
        ...
        string operationName)
    {
            ...
            && startSchedule.EventRequest != null)
        {
            ...
            _logger.LogInformation($"HikAgvHandler - 【{operationName}】,task:【{agvTask.Id}】,Start Device Invoke Service.\r\n");
            ...
            _logger.LogInformation($"HikAgvHandler - 【{operationName}】,task:【{agvTask.Id}】,Start Device Set Schedule Finished.\r\n");
            ...
            _logger.LogInformation($"HikAgvHandler - 【{operationName}】,task:【{agvTask.Id}】,Start Device Add Schedule Log.\r\n");
        }
    }
}
