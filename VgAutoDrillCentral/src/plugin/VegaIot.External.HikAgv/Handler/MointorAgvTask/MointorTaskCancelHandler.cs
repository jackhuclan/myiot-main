...
public class MointorTaskCancelHandler
{
        ...
        QueryTaskStatusData hikAgvData)
    {
        ...
        {
            _logger.LogInformation($"HikAgvTaskMonitor:Excute MointorTaskCancelHandler...start...first schedule...agvTask:{agvTask.Id},startSchedule:{agvTask.StartScheduleId}");
            ...
            _logger.LogInformation($"HikAgvTaskMonitor:Excute MointorTaskCancelHandler...end...first schedule...agvTask:{agvTask.Id},startSchedule:{agvTask.StartScheduleId}");
        }
        ...
        {
            _logger.LogInformation($"HikAgvTaskMonitor:Excute MointorTaskCancelHandler...start...second schedule...agvTask:{agvTask.Id},endSchedule:{agvTask.EndScheduleId}");
            ...
            _logger.LogInformation($"HikAgvTaskMonitor:Excute MointorTaskCancelHandler...end...second schedule...agvTask:{agvTask.Id},endSchedule:{agvTask.EndScheduleId}");
        }
