...
/// 熟料从线边仓拉到下PIN
/// </summary>
public class DrilledFromWipToUnPinHandler
{
    private readonly ILogger<DrilledFromWipToUnPinHandler> _logger;
    ...
    public DrilledFromWipToUnPinHandler(ILogger<DrilledFromWipToUnPinHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,task:【{agvTask.Id}】,Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,task:【{agvTask.Id}】,The verification of device and locations has been passed.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,task:【{agvTask.Id}】,End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,开始-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        string message = "熟料:线边仓->下PIN，离开线边仓,下发完成信息";
        string operationName = "DrilledFromWipToUnPinHandler";
        ...
        {
            TransferJobId = agvTask.Id,
            Message = $"车辆已到达，离开【熟料】线边仓，结束-执行第一段任务."
        });

        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,结束-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,开始-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - DrilledFromWipToUnPinHandler,结束-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
}
