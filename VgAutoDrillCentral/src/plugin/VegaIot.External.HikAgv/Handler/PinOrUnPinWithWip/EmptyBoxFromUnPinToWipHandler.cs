...
/// 空料仓从下PIN拉到线边仓
/// </summary>
public class EmptyBoxFromUnPinToWipHandler
{
    private readonly ILogger<EmptyBoxFromUnPinToWipHandler> _logger;
    ...
    public EmptyBoxFromUnPinToWipHandler(ILogger<EmptyBoxFromUnPinToWipHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,task:【{agvTask.Id}】,Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,task:【{agvTask.Id}】,The verification of device and locations has been passed.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,task:【{agvTask.Id}】,End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,开始-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        string message = "空料仓:下PIN->线边仓，离开下PIN,下发完成信息";
        string operationName = "EmptyBoxFromUnPinToWipHandler";
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,结束-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,开始-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        {
            TransferJobId = agvTask.Id,
            Message = $"车辆已到达，离开【空仓】线边仓，结束-执行第二段任务."
        });
        ...
        _logger.LogInformation($"HikAgvHandler - EmptyBoxFromUnPinToWipHandler,结束-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
}
