...
/// 生料从上PIN拉到线边仓
/// </summary>
public class UndrilledFromPinToWipHandler
{
    private readonly ILogger<UndrilledFromPinToWipHandler> _logger;
    ...
    public UndrilledFromPinToWipHandler(ILogger<UndrilledFromPinToWipHandler> logger,
        ...
        HikArrivedRequestEntity status)
    {
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,task:【{agvTask.Id}】,Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,task:【{agvTask.Id}】,End Excute Handle==========================\r\n");
    ...
    {
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,开始-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        string message = "生料:上PIN->线边仓，离开上PIN,下发完成信息";
        string operationName = "UndrilledFromPinToWipHandler";
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,结束-执行第一段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
    ...
    {
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,开始-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
        ...
        _logger.LogInformation($"HikAgvHandler - UndrilledFromPinToWipHandler,结束-执行第二段任务，料仓任务:【{agvTask.Id}】.\r\n");
    }
}
