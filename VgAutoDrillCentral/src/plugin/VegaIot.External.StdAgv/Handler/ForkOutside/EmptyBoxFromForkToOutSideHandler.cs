...
public class EmptyBoxFromForkToOutSideHandler
{
    ...
    public async Task<StdArrivedResponseEntityV2> Handle(TransferJob agvTask, String methodName, String vehicleName)
    {
        ...
        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
             ...
             && startSchedule.EventRequest != null)
        {
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},Device Invoke Service.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},Set Schedule Finished.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},Add Schedule Log Request.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},Update Database agvTask.\r\n");
        }

        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromForkToOutSideHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
