...
public class EmptyBoxFromOutSideToForkHandler
{
    ...
    public async Task<StdArrivedResponseEntityV2> Handle(TransferJob agvTask, String methodName, String vehicleName, string siloCode)
    {
        var response = new StdArrivedResponseEntityV2();

        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
            ...
            && endSchedule.EventRequest != null)
        {
            ...
            panels.SetEmpty("", siloCode);

            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Set Panels is Empty.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Set Schedule Finished.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Device Invoke Service.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Add Schedule Log Request.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},Update Database agvTask.\r\n");
        }

        _logger.LogInformation($"StdAgvHandler - EmptyBoxFromOutSideToForkHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
