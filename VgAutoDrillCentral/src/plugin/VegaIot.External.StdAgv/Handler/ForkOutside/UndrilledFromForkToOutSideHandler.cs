...
/// 生料仓从内部中转位运转外部
/// </summary>
public class UndrilledFromForkToOutSideHandler
{
    private readonly ILogger<UndrilledFromForkToOutSideHandler> _logger;
    ...
    public UndrilledFromForkToOutSideHandler(IServiceProvider serviceProvider)
    {
        var loggerFactory = serviceProvider.GetRequiredService<ILoggerFactory>();
        _logger = loggerFactory.CreateLogger<UndrilledFromForkToOutSideHandler>();
    ...
    public async Task<StdArrivedResponseEntityV2> Handle(TransferJob agvTask, String methodName, String vehicleName)
    {
        ...
        _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},Start Excute Handle==========================\r\n");
        ...
        _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},The verification of device and locations has been passed.\r\n");
             ...
             && startSchedule.EventRequest != null)
        {
            ...
            _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},Device Invoke Service.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},Set Schedule Finished.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},Add Schedule Log Request.\r\n");
            ...
            _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},Update Database agvTask.\r\n");
        }

        _logger.LogInformation($"StdAgvHandler - UndrilledFromForkToOutSideHandler,task:{agvTask.Id},End Excute Handle==========================\r\n");
