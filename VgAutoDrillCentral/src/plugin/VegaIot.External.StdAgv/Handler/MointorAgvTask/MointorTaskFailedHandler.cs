...
public class MointorTaskFailedHandler
{
        ...
        QueryTaskStatusData hikAgvData)
    {
        ...
        {
            _logger.LogInformation($"StdAgvTaskMonitor:Excute MointorTaskFailedHandler...start...first schedule...agvTask:{agvTask.Id},startSchedule:{agvTask.StartScheduleId}");
            ...
            _logger.LogInformation($"StdAgvTaskMonitor:Excute MointorTaskFailedHandler...end...first schedule...agvTask:{agvTask.Id},startSchedule:{agvTask.StartScheduleId}");
        }
        ...
        {
            _logger.LogInformation($"StdAgvTaskMonitor:Excute MointorTaskFailedHandler...start...second schedule...agvTask:{agvTask.Id},endSchedule:{agvTask.EndScheduleId}");
            ...
            _logger.LogInformation($"StdAgvTaskMonitor:Excute MointorTaskFailedHandler...end...second schedule...agvTask:{agvTask.Id},endSchedule:{agvTask.EndScheduleId}");
        }
