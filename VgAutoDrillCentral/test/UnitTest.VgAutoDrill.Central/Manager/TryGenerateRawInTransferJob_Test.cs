...
public class TryGenerateRawInTransferJob_Test : CentralTestBase
{
    [Fact]
    public async Task Test()
    {
        ...
        //await transferPlanManager.Refresh();
        //var transferJob = await transferPlanManager.trygen();
        //Assert.NotNull(transferJob);
    }
}
