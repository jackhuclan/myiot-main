...
public class LongSlotInf
{
    public int LineNum { get; set; }
    public LongSlotInf(int line)
    {
        LineNum = line;
    }
    ...
    {
        return $"A{LineNum},{Use},{ChangeData(MinD)},{ChangeData(MaxD)},{Type},{ChangeData(Roughn)},{ChangeData(InfeedFirst)},{ChangeData(InfeedFast)},{ChangeData(InfeedSlow)},{GetInchData(Roughn)}";
    }
}
