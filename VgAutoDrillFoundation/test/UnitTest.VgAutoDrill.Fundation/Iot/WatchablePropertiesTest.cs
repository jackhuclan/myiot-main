...
using UnitTest;
using UnitTest.VgAutoDrill;
using UnitTest.VgAutoDrill.Fundation;
using UnitTest.VgAutoDrill.Fundation.Iot;
...
public class WatchablePropertiesTest
{
    ...
    [Fact]
    [Trait("Category", "sychronized test")]
    public void ShouldTriggerAlways_OnSameProperty_WhenPropertyValueChanged()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", "")
    ...
    [Fact]
    [Trait("Category", "sychronized test")]
    public void ShouldTriggerMultipleActions_WithSameProperty()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", "0")
        ...
        watchableProperties.Properties("a", "b")
            .PostCondition(p => p.Property("a").NewValue?.ToString() == "1"
                                && p.Property("b").NewValue?.ToString() == "1")
            .TriggerOnce(() =>
            {
                Interlocked.Increment(ref count);
            });
    ...
    [Fact]
    [Trait("Category", "normal test")]
    public void WatchSameProperty_VerifyOldValueAndNewValue()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", "0")
        ...
        watchableProperties.Properties("a", "b")
            .PostCondition(wp => wp.Property("a").OldValue == "0"
                && wp.Property("a").NewValue == "1"
                && wp.Property("b").NewValue == "1")
            .TriggerAlways(() =>
            {
                var aOldValue = watchableProperties.Property("a").OldValue;
                var aNewValue = watchableProperties.Property("a").NewValue;
                Interlocked.Increment(ref count);
                Assert.Equal("0", aOldValue);
                Assert.Equal("1", aNewValue);
            });
    ...
    [Fact]
    [Trait("Category", "normal test")]
    public void WatchSamePropertyMultipleTimes_VerifyOldValueAndNewValue()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", "0")
        ...
        watchableProperties.Property("a")
            .PostCondition(wp => wp.IsValueChanged)
            .TriggerAlways(() =>
            {
                var aOldValue = watchableProperties.Property("a").OldValue;
                var aNewValue = watchableProperties.Property("a").NewValue;
        ...
        watchableProperties.Property("a")
            .PostCondition(wp => wp.OldValue == "0"
                && wp.NewValue == "1")
            .TriggerAlways(() =>
            {
                var aOldValue = watchableProperties.Property("a").OldValue;
    ...
    [Fact]
    [Trait("Category", "normal test")]
    public void WatchSamePropertyMultipleTimes_VerifyOldValueAndNewValue2()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", 0)
        ...
        watchableProperties.Property("a")
            ...
            .TriggerAlways(() =>
            {
                var aOldValue = (int)watchableProperties.Property("a").OldValue;
                var aNewValue = (int)watchableProperties.Property("a").NewValue;
                Assert.Equal(aOldValue, aNewValue - 1);
                Assert.Equal(aOldValue, count);
                Interlocked.Increment(ref count);
            });

        for (int i = 1; i <= 100; i++)
        {
            watchableProperties.SetValues(new Dictionary<string, object?> { { "a", i } });
        }
    }

    [Fact]
    [Trait("Category", "normal test")]
    public void WatchSamePropertyMultipleTimes_VerifyOldValueAndNewValue3()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", 0)
        ...
        watchableProperties.Properties("a", "b")
            ...
            .TriggerAlways(() =>
            {
                ...
                var bOldValue = (int)watchableProperties.Property("b").OldValue;
                var bNewValue = (int)watchableProperties.Property("b").NewValue;
                Assert.Equal(bOldValue, bNewValue - 1);
            });

        for (int i = 1; i <= 100; i++)
        {
            watchableProperties.SetValues(new Dictionary<string, object?> { { "a", i }, { "b", i + 1 } });
        }
    }
    ...
    [Fact]
    [Trait("Category", "sychronized test")]
    public void ShouldTriggerAlways_WithSameMultiProperty_WhenAnyPropertyValueChanged()
    {
        int count = 0;
        WatchableProperties watchableProperties = new WatchableProperties();
        watchableProperties.AddProperty("a", "")
