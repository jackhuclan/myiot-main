...
internal class Everything64
{
    ...
    [DllImport("Everything64.dll")]
    public static extern nint Everything_GetSearchW();
    ...
    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultFileName(uint nIndex);
    ...
    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultExtension(uint nIndex);
    ...
    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultFileListFileName(uint nIndex);
    ...
    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultHighlightedFileName(uint nIndex);

    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultHighlightedPath(uint nIndex);

    [DllImport("Everything64.dll", CharSet = CharSet.Unicode)]
    public static extern nint Everything_GetResultHighlightedFullPathAndFileName(uint nIndex);
