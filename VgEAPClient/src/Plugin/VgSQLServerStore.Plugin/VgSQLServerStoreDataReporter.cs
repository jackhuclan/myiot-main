...
public class VgSQLServerStoreDataReporter : IHttpDataReporter, IDisposable
{
    private readonly ILogger<VgSQLServerStoreDataReporter> _logger;
    ...
    public VgSQLServerStoreDataReporter(ILogger<VgSQLServerStoreDataReporter> logger,
