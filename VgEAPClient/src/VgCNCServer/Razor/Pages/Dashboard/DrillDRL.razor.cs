...
public partial class DrillDRL
{
    ...
    protected override void OnInitialized()
    {
        ...
        PageTabsProvider?.UpdateTabTitle(Nav.GetAbsolutePath(), () => T("DrlKanban"));
    }
    ...
    private void Refresh()
    {
        ...
        foreach (var drill in drillListMy)
        {
            if (drill.sEqpType.IsNullOrWhiteSpace() || drill.sEqpType.ToStringEx().Equals("DRL", StringComparison.OrdinalIgnoreCase))
            {
