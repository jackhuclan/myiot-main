...
using VgEAPClient.Common.OpcUaServer.SharpNodeSettings.Core;
using ApplicationConfiguration = Opc.Ua.ApplicationConfiguration;
...
public partial class EmptyNodeManager : CustomNodeManager2
{
    ...
    /// </summary>
    public EmptyNodeManager(IServerInternal server, ApplicationConfiguration configuration, EAPClientOptions eAPClientOptions)
    : base(server, configuration, VgEAPClient.Common.OpcUaServer.Namespaces.ReferenceApplications)
    {
        ...
        _eAPClientOptions = eAPClientOptions;
    }
    ...
    */
    ...
    private readonly SharpNodeServer sharpNodeServer = null;
    private readonly Dictionary<string, List<RegularItemNode>> dicRegularItemNode = null;
    private readonly Dictionary<string, BaseDataVariableState> dict_BaseDataVariableState;    // 节点管理器

    #endregion SharpNodeSettings Server
    ...
    private readonly UInt16 m_simulationInterval = 1000;
    private readonly bool m_simulationEnabled = true;
