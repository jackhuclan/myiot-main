...
{
    public EmptyNodeManager? emptyNodeManager;
    ...
    public SharpNodeSettingsServer(EAPClientOptions eAPClientOptions)
    {
    ...
    {
        if (emptyNodeManager != null)
        {
            emptyNodeManager.ChangeNodeValue(key, value);
        }
    }
    ...
    public object getNodeValue(string key)
    {
        if (emptyNodeManager != null)
        {
            return emptyNodeManager.GetNodeValue(key);
        }
        return null;
    }
    ...
    protected override MasterNodeManager CreateMasterNodeManager(IServerInternal server, ApplicationConfiguration configuration)
    {
        ...
        emptyNodeManager = new EmptyNodeManager(server, configuration, _eAPClientOptions);
        emptyNodeManager.extradrilList.AddRange(extradrilList);
        emptyNodeManager.NotUseEqpName = NotUseEqpName;
