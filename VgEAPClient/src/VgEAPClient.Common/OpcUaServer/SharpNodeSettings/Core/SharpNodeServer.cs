...
namespace VgEAPClient.Common.OpcUaServer.SharpNodeSettings.Core;
...
public class SharpNodeServer
{
    ...
    private readonly Dictionary<string, List<RegularItemNode>> regularkeyValuePairs;            // 所有的解析规则列表的对象
    ...
    private readonly HslCommunication.Core.SimpleHybirdLock settingsLock;                       // 配置文件加载的锁
    private NetSimplifyServer simplifyServer;                                          // 同步数据访问服务器
    private readonly XElement xElementSettings;                                                 // 全部的配置文件信息
