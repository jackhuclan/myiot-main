  ...
  <div class="app-container">
    ...
    <el-card class="page-body">
      <el-table :ref="page" v-loading="loading" :data="list" border>
        ...
        <el-table-column label="白班稼动率" align="center" prop="sDutyShiftA">
        </el-table-column>
        <el-table-column label="中班稼动率" align="center" prop="sDutyShiftC">
        </el-table-column>
        <el-table-column label="夜班稼动率" align="center" prop="sDutyShiftB">
        </el-table-column>
      </el-table>
      <pagination
        v-show="total > 0"
...
<script>
import { queryDutyList } from "@/api/duty";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      this.loading = true;
      queryDutyList(this.queryParams).then((res) => {
        this.list = res.List;
