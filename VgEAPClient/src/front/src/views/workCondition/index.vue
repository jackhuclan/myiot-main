  ...
  <div class="app-container">
    ...
    <el-card class="page-body">
      <el-table :ref="page" v-loading="loading" :data="list" border>
        ...
        <el-table-column label="时间" align="center" prop="sTime">
        </el-table-column>
        ...
        <el-table-column label="加工孔数" align="center" prop="sNeeded">
        </el-table-column>
...
<script>
import { queryorkConditionList } from "@/api/workCondition";
export default {
  data() {
    return {
      page: "WorkCondition",
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      this.loading = true;
      queryorkConditionList(this.queryParams).then((res) => {
        this.list = res.List;
